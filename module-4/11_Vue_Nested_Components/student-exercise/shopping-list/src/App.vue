<template>
  <div id="app">
    ...
    <shopping-list title="Grocery Store" v-bind:search="search" v-bind:items="groceries"></shopping-list>
    <shopping-list title="Costco" v-bind:search="search" v-bind:items="costco"></shopping-list>
    <shopping-list title="Target" v-bind:search="search" v-bind:items="target"></shopping-list>
  </div>
</template>
